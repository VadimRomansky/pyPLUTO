...
def plot_Bturb(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'Bturb.png', excl_axis = 3, point = 0.5, aspect = 'equal', transponse = False, out_dir = ""):
