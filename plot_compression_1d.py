...
def plot_compression_1d(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'compression_1d.png', axis = 1, point1 = 0.5, point2 = 0.5, out_dir = ""):
