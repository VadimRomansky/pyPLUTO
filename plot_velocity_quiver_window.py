...
def plot_velocity_quiver_window(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax, datatype, file_name = 'velocity_quiver_window.png', excl_axis = 3, point = 0.5, out_dir = ""):
    c = 2.998E10
