...
def plot_pressure_animated_1d(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'pressure_1d.gif', axis = 1, point1 = 0.5, point2 = 0.5, out_dir = ""):
