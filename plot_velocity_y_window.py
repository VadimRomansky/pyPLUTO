...
def plot_velocity_y_window(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax):
    c=2.998E10
    ...
    D = pp.pload(ns, varNames = ['vx2'], w_dir = w_dir, datatype='dbl')  # Load fluid data.
