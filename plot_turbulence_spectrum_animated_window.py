...
def plot_turbulence_spectrum_animated_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax, zmin, zmax, datatype, file_name = 'turbulence_spectrum_window.gif', out_dir = ""):
