...
def plot_velocity_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'velocity.gif', excl_axis = 3, point = 0.5, aspect = 'equal', transponse = False):
    c = 2.998E10
