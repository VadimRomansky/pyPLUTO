...
def plot_gamma_rtheta_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'gamma_rtheta.gif', out_dir = ""):
    ...
    def update(frame_number):
        ...
        gamma2=gamma[:,range(int(nx/Nfraction))]
        im2 = plt.pcolormesh(th, r, gamma2, norm=colors.LogNorm(vmin=minV, vmax=maxV))
