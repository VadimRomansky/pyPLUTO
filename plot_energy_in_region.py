...
def plot_energy_in_region(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, xmin, xmax, ymin = 0, ymax = 0, zmin = 0, zmax = 0, file_name = 'energy_in_region.png', out_dir = ""):
    c = 2.998E10
    gam = 5.0/3.0
    mp = 1.6E-24
    fracHe = 0.1
