...
def plot_temperature_window(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax, datatype, file_name = 'temperature_window.png', excl_axis = 3, point = 0.5, aspect = 'equal'):
