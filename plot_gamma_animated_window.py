...
def plot_gamma_animated_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax, datatype, file_name = 'gamma_window.gif', excl_axis = 3, point = 0.5, aspect = 'equal', transponse = False, out_dir = ""):
    c = 2.998E10
    ...
    def update(frame_number):
        ...
        im2 = ax.imshow(gamma, origin='upper', norm=colors.LogNorm(vmin=minV, vmax=maxV), aspect = aspect,
