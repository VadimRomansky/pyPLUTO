...
plot_B_quiver_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, 0, 5E19, 0, 2E20, datatype, out_dir = out_dir)
...
plot_density_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, 0.0, 5E19, 0.5E20, 1.5E20, datatype, file_name = 'density_west.png', transponse = True, out_dir = out_dir)
plot_density_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, 0.0, 5E19, -1.5E20, -0.5E20, datatype, file_name = 'density_east.png', transponse = True, out_dir = out_dir)
...
plot_density_1d(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'density_1d_1.png', axis = 2, point1 = 0.0, out_dir = out_dir)
