...
plot_kinetic_distribution_at_p_along_axis(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, 5, file_name = 'distribution_at_momentum_low_p.png', out_dir = out_dir)
plot_kinetic_distribution_at_p_along_axis(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, 20, file_name = 'distribution_at_momentum_mid_p.png', out_dir = out_dir)
plot_kinetic_distribution_at_p_along_axis(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, 45, file_name = 'distribution_at_momentum_high_p.png', out_dir = out_dir)
