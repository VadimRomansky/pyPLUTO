...
from plot_B_rtheta import plot_B_rtheta
from plot_B_rtheta_animated import plot_B_rtheta_animated
from plot_B_rphi import plot_B_rphi
...
from plot_density_rtheta import plot_density_rtheta
from plot_density_rtheta_animated import plot_density_rtheta_animated
...
from plot_particles_animated_rphi import plot_particles_animated_rphi
...
from plot_pressure_rtheta import plot_pressure_rtheta
from plot_pressure_rtheta_animated import plot_pressure_rtheta_animated
...
from plot_temperature_rtheta import plot_temperature_rtheta
from plot_temperature_rtheta_animated import plot_temperature_rtheta_animated
...
from plot_velocity_rtheta import plot_velocity_rtheta
from plot_velocity_rtheta_animated import plot_velocity_rtheta_animated
...
#plot_B_rphi(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
...
#plot_B_rtheta(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_B_rtheta_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
...
#plot_pressure_rtheta(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_pressure_rtheta_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
...
#plot_temperature_rtheta(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_temperature_rtheta_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)

########### gamma

#plot_gamma(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_gamma_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, -1E16, 1E16, -1E16, 1E16, datatype)
#plot_gamma_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_gamma_animated_window(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, -1E16, 1E16, -1E16, 1E16, datatype)
...
#plot_velocity_rtheta(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
#plot_velocity_rtheta_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype)
...
#plot_particles_animated_rphi(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, -2E16, 2E16, datatype)
