...
def plot_gamma_rtheta(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY,datatype, file_name = 'gamma_rtheta.png', out_dir = ""):
    ...
    gamma1 = gamma[:,range(int(nx/Nfraction))]
    im2 = plt.pcolormesh(th, r, gamma1, norm = colors.LogNorm(vmin = minV, vmax = maxV))
