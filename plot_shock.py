...
def plot_shock(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'shock.png', excl_axis = 3, point = 0.5, aspect = 'equal', transponse = False, out_dir = ""):
