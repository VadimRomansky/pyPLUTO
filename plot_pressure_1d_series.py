...
def plot_pressure_1d_series(number, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'pressure_1d_series.png', axis = 1, point1 = 0.5, point2 = 0.5, out_dir = ""):
