...
def plot_Bz_window(ns, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, xmin, xmax, ymin, ymax):
    ...
    D = pp.pload(ns, varNames = ['Bx3'], w_dir = w_dir, datatype='dbl')  # Load fluid data.
