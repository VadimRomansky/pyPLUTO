...
def plot_Pkin_animated(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'Pkin.gif', excl_axis = 3, point = 0.5, aspect = 'equal', transponse = False, out_dir = ""):
