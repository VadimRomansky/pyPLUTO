...
def plot_velocity_z_1d(ntot, w_dir, UNIT_DENSITY, UNIT_LENGTH, UNIT_VELOCITY, datatype, file_name = 'velocity_z_1d.png', axis = 1, point1 = 0.5, point2 = 0.5, out_dir = ""):
    c = 2.998E10
    ...
    V = getScalarArray_1d(D.vx3, UNIT_VELOCITY/c, axis, point1, point2)
